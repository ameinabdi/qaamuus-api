...
export default class UserRepository {
   ...
   * @param {*} [options]
   */
  static async createFromAuthPhone(
    data,
    options: IRepositoryOptions,
  ) {
    const transaction = SequelizeRepository.getTransaction(
   ...
   * @param {*} [options]
   */
  static async generatePhonelVerificationCode(
    phoneNumber,
    verificationCode,
    options: IRepositoryOptions,
  ) {
   ...
   * @param {*} [options]
   */
  static async generatePasswordResetPhone(
    phoneNumber,
    verificationCode,
    options: IRepositoryOptions,
  ) {
   ...
   * @param {*} [options]
   */
  static async findByPhoneVerificationCode(
    code,
    options: IRepositoryOptions,
  ) {
    const transaction = SequelizeRepository.getTransaction(
   ...
   * @param {*} [options]
   */
  static async markPhoneVerified(
    id,
    options: IRepositoryOptions,
  ) {
    const currentUser = SequelizeRepository.getCurrentUser(
